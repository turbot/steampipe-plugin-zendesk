...
- Recompiled plugin with Go version `1.24`. ([#66](https://github.com/turbot/steampipe-plugin-zendesk/pull/66))
- Recompiled plugin with [steampipe-plugin-sdk v5.13.1](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5131-2025-09-25) that addresses critical and high vulnerabilities in dependent packages. ([#67](https://github.com/turbot/steampipe-plugin-zendesk/pull/67))
