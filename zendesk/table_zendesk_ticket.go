...
func tableZendeskTicket() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "created_at", Type: proto.ColumnType_DATETIME, Description: "When this record was created"},
			...
			{Name: "due_at", Type: proto.ColumnType_DATETIME, Description: "If this is a ticket of type \"task\" it has a due date. Due date format uses ISO 8601 format."},
			...
			{Name: "updated_at", Type: proto.ColumnType_DATETIME, Description: "When this record last got updated"},
