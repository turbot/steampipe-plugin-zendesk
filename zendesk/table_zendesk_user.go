...
func tableZendeskUser() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "created_at", Type: proto.ColumnType_DATETIME, Description: "The time the user was created"},
			...
			{Name: "last_login_at", Type: proto.ColumnType_DATETIME, Description: "The last time the user signed in to Zendesk Support"},
			...
			{Name: "updated_at", Type: proto.ColumnType_DATETIME, Description: "The time the user was last updated"},
